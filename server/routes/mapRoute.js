...
const { addName, mapInfo, addMap,getAllMaps, getGeoMapinfo,updateGeoMap,deleteMap, getAllCoordinateMaps,deleteMapName, viewAllMaps } = require('../controllers/mapController');
